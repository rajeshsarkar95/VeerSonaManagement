...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div
            ...
            className="text-white px-6 py-1 rounded-lg text-center cursor-pointer active:scale-95 transition"
          >
            Login
          </div>
          </nav>
      ...
      <div
        className={`lg:hidden bg-charcoal/98 backdrop-blur-md transition-all duration-500 overflow-hidden ${mobileOpen ? 'max-h-96 py-4' : 'max-h-0'
          }`}
      >
